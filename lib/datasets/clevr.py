...
class clevr(imdb):
    def __init__(self, image_set, devkit_path=None):
        ...
        assert os.path.exists(self._devkit_path), \
            'CLEVRdevkit path does not exist: {}'.format(self._devkit_path)
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', 'CLEVR', 'Main')
    ...
    def _do_python_eval(self, output_dir='output'):
        ...
        use_07_metric = False
        print 'CLEVR metric? ' + ('Yes' if use_07_metric else 'No')
